...
{
    const int argc = 6;
    const CHAR *argv[argc] = {SL("program.exe"), SL("add"), SL("-f"), SL("test.txt"), SL("-d"), SL("-r")};

    CmdLine cmd(argc, argv, CmdLine::CommandIsRequired);

    cmd.addCommand(SL("add"), ValueOptions::NoValue, false, SL("Add file."))
        .addAllOfGroup(SL("file group"))
        .addArgWithFlagAndName(SL('f'), SL("file"), true, false, SL("Name of the file."), SL(""), SL(""), SL("fn"))
        .end()
        .addArgWithFlagOnly(SL('d'), false, false, SL("Do job."))
        .end()
        .addCommand(SL("delete"), ValueOptions::NoValue, false, SL("Delete file."))
        .addArgWithFlagOnly(SL('d'), false, false, SL("Do NOT job."))
        .end()
        .addArgWithFlagAndName(SL('r'), SL("recurcieve"), false, false, SL("Do operation recurcively?"))
        .addHelp(true, argv[0], SL("This application just show power of the Args help."))
...
TEST_CASE("TestAllIsOkReparse")
{
    ...
    const int nargc = 2;
    const CHAR *nargv[nargc] = {SL("program.exe"), SL("delete")};
...
TEST_CASE("TestGetterSetterOfArg")
{
    ...
    cmd.addArgWithFlagAndName(SL('1'), SL("11"), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .addArgWithFlagOnly(SL('2'), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .addArgWithNameOnly(SL("33"), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"));
    ...
    const auto *a2 = static_cast<const Arg *>(tmpCmd.findArgument(SL("-2")));
...
TEST_CASE("TestGetterSetterOfMultiArg")
{
    ...
    cmd.addMultiArg(SL('1'), SL("11"), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .addMultiArgWithFlagOnly(SL('2'), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .addMultiArgWithNameOnly(SL("33"), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"));
    ...
    const auto *a3 = static_cast<const Arg *>(tmpCmd.findArgument(SL("--33")));
...
TEST_CASE("TestGetterSetterOfMultiArgWithValues")
{
    ...
    cmd.addMultiArgWithDefaulValues(SL('1'),
                                    SL("11"),
                                    true,
                                    false,
                                    SL("desc"),
        ...
        .addMultiArgWithFlagOnlyAndDefaultValues(SL('2'),
                                                 ...
                                                 {SL("val1"), SL("val2")},
                                                 SL("vs"))
        .addMultiArgWithNameOnlyAndDefaultValues(SL("33"),
                                                 true,
                                                 false,
                                                 SL("desc"),
                                                 SL("long desc"),
...
TEST_CASE("TestGetterSetterOfArgInGroup")
{
    ...
    cmd.addAllOfGroup(SL("group"))
        .addArgWithFlagAndName(SL('1'), SL("11"), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .addArgWithFlagOnly(SL('2'), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .addArgWithNameOnly(SL("33"), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .end();
...
TEST_CASE("TestGetterSetterOfMultiArgInGroup")
{
    ...
    cmd.addAllOfGroup(SL("group"))
        .addMultiArg(SL('1'), SL("11"), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .addMultiArgWithFlagOnly(SL('2'), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .addMultiArgWithNameOnly(SL("33"), true, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .end();
...
TEST_CASE("TestGetterSetterOfMultiArgWithValuesInGroup")
{
    ...
    cmd.addAllOfGroup(SL("group"))
        .addMultiArgWithDefaulValues(SL('1'),
                                     SL("11"),
                                     true,
                                     false,
                                     SL("desc"),
...
TEST_CASE("TestGetterSetterOfCommand")
{
    ...
    cmd.addCommand(SL("cmd1"), ValueOptions::OneValue, false, SL("desc"), SL("long desc"), SL("val"), SL("vs"))
        .end()
        .addCommandWithDefaultValues(SL("cmd2"),
                                     ValueOptions::ManyValues,
                                     false,
                                     SL("desc"),
                                     SL("long desc"),
                                     {SL("val1"), SL("val2")},
    ...
    auto *a1 = static_cast<Command *>(cmd.findArgument(SL("cmd1")));
    ...
    const auto *a2 = static_cast<const Command *>(tmpCmd.findArgument(SL("cmd2")));
...
TEST_CASE("JustCompileIt")
{
    ...
    cmd.addCommandWithDefaultValues(SL("cmd1"),
                                    ValueOptions::NoValue,
                                    false,
                                    SL("1"),
                                    SL("2"),
                                    {SL("1"), SL("2")},
                                    SL("3"))
        .addOnlyOneGroup(SL("group1"), false)
        .end()
        .addAllOfGroup(SL("group2"), false)
        .end()
        .addAtLeastOneGroup(SL("group3"), false)
        .end()
        .addArgWithFlagAndName(SL('a'), SL("flag1"), true, false, SL("1"), SL("2"), SL("3"), SL("vs"))
        .addArgWithFlagOnly(SL('b'), false, false, SL("1"), SL("2"), SL("3"), SL("vs"))
        .addArgWithNameOnly(SL("flag2"), false, false, SL("1"), SL("2"), SL("3"), SL("vs"))
        .addMultiArg(SL('c'), SL("flag3"), false, false, SL("1"), SL("2"), SL("3"), SL("vs"))
        .addMultiArgWithFlagOnly(SL('d'), false, false, SL("1"), SL("2"), SL("3"), SL("vs"))
        .addMultiArgWithNameOnly(SL("flag4"), false, false, SL("1"), SL("2"), SL("3"), SL("vs"))
        .addMultiArgWithDefaulValues(SL('e'), SL("flag5"), false, false, SL("1"), SL("2"), {SL("3"), SL("4")}, SL("vs"))
        .addMultiArgWithFlagOnlyAndDefaultValues(SL('f'), false, false, SL("1"), SL("2"), {SL("3"), SL("4")}, SL("vs"))
        .addMultiArgWithNameOnlyAndDefaultValues(SL("flag6"),
                                                 false,
                                                 false,
                                                 SL("1"),
                                                 SL("2"),
                                                 {SL("3"), SL("4")},
                                                 SL("vs"))
        .addCommand(SL("cmd2"), ValueOptions::NoValue, false, SL("1"), SL("2"), SL("3"), SL("vs"))
        .end()
        .addCommandWithDefaultValues(SL("cmd3"),
                                     ValueOptions::NoValue,
                                     false,
                                     SL("1"),
                                     SL("2"),
...
{
    const int argc = 3;
    const CHAR *argv[argc] = {SL("program.exe"), SL("compress"), SL("./dir")};

    CmdLine cmd(argc, argv);

    cmd.addCommand("extract", ValueOptions::OneValue, false, "Extract file", "", "", "fn")
        .end()
        .addOnlyOneGroup("use command or option, not both")
        .addCommand("compress", ValueOptions::OneValue, false, "Compress file", "", "", "fn")
        .end()
        .addArgWithFlagOnly('c', true, false, "Compress file", "Compress file or folder", "", "fn")
        .end()
...
{
    const int argc = 3;
    const CHAR *argv[argc] = {SL("program.exe"), SL("-c"), SL("./dir")};
...
{
    const int argc = 3;
    const CHAR *argv[argc] = {SL("program.exe"), SL("extract"), SL("1.zip")};

    CmdLine cmd(argc, argv);

    cmd.addCommand("extract", ValueOptions::OneValue, false, "Extract file", "Extract file", "", "fn")
        .end()
        .addOnlyOneGroup("use command or option, not both")
        .addCommand("compress", ValueOptions::OneValue, false, "Compress file", "Compress file", "./", "fn")
        .end()
        .addArgWithFlagOnly('c', true, false, "Compress file", "Compress file or folder", "", "fn")
        .end()
        .addHelp(true, argv[0], "unzip application");
...
{
    const int argc = 5;
    const CHAR *argv[argc] = {SL("program.exe"), SL("-c"), SL("./dir"), SL("compress"), SL("./dir")};
...
TEST_CASE("CommandInGroup5")
{
    ...
    cmd.addCommand("extract", ValueOptions::OneValue, false, "Extract file", "Extract file", "", "fn")
        .end()
        .addOnlyOneGroup("use command or option, not both")
        .addCommandWithDefaultValues("compress",
                                     ValueOptions::OneValue,
                                     false,
                                     "Compress file",
                                     "Compress file",
                                     {"./", "~/Work"},
...
{
    const int argc = 4;
    const CHAR *argv[argc] = {SL("program.exe"), SL("extract"), SL("file"), SL("1.zip")};

    CmdLine cmd(argc, argv);

    cmd.addOnlyOneGroup("command or option")
        .addCommand("extract", ValueOptions::NoValue, true, "Extract file", "Extract file", "", "")
        .addOnlyOneGroup("file or folder")
        .addCommand("file", ValueOptions::ManyValues, false, "Extract file", "Extract file", "", "fn")
        .end()
        .addCommand("folder", ValueOptions::ManyValues, false, "Extract folder", "Extract folder", "", "dir")
        .end()
        .end()
        .end()
...
{
    const int argc = 2;
    const CHAR *argv[argc] = {SL("program.exe"), SL("extract")};
